    ...
    methods:{
        init () {
            ...
            if (json.province_id != 0) {
                ...
                this.district.id = json.district_id;
                this.district.name = json.district_name;
                this.labelData = this.province.name + this.city.name + json.district_name;
            }
            else {
                this.getRegions(1)
        ...
        selectTab: function(tabKeyword) {
            switch (tabKeyword) {
                ...
                break;
                case 'city':
                    if (this.province.id === 0 || this.areaStart > 1) {
                        return false;
                    }
                    else {
                        this.selectedTab = tabKeyword
                ...
                break;
                case 'district':
                    if (this.province.id === 0 || this.city.id === 0) {
                        return false;
                    }
                    else {
                        this.selectedTab = tabKeyword
