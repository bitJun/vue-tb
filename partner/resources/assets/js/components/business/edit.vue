<template>
  <div class="business_add">
    <h4 class="title">
      <Breadcrumb>
        <BreadcrumbItem to="/business">商家列表</BreadcrumbItem>
        <BreadcrumbItem>编辑商家</BreadcrumbItem>
      </Breadcrumb>
    </h4>
    <Form ref="businseeData" :model="businseeData" :rules="ruleValidate"  class="add_form" :label-width="100">
      <FormItem label="商家名称" prop="company">
        <Input v-model="businseeData.name" placeholder="请输入商家名称" style="width: 400px"></Input>
      </FormItem>
      ...
      <FormItem label="联系电话" prop="mobile">
        <Input v-model="businseeData.tel" placeholder="请输入联系电话" style="width: 400px"></Input>
      </FormItem>
      <FormItem label="店铺地址">
      ...
      <FormItem label="店铺图片" prop="pwd">
        <UploadList ref="imgupload" :action="uploadAction" v-model="businseeData.imgs"></UploadList>
      </FormItem>
      <FormItem label="店铺介绍" prop="account">
        <Input v-model="businseeData.intro" type="textarea" :autosize="{minRows: 2,maxRows: 5}" placeholder="请输入店铺介绍" style="width: 400px"></Input>
      </FormItem>
      <FormItem>
