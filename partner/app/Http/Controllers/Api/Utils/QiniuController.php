...
class QiniuController extends Controller
{
    ...
    public function qiniuToken()
    {
        ...
        $policy = array(
            ...
            'callbackBody' => 'partner_id=$(x:partner_id)&url=$(key)&file_name=$(fname)&file_size=$(fsize)&file_ext=$(ext)&mime_type=$(mimeType)&imageinfo=$(imageInfo)&avinfo=$(avinfo)',
        );
    ...
    public function qiniuUpload() {
        ...
        $policy = array(
            ...
            'callbackBody' => 'tmp_name='.$pathName.'&partner_id='.Request::input('partner_id').'&url=$(key)&file_name='.$fileName.'&file_size=$(fsize)&file_ext=$(ext)&mime_type=$(mimeType)&imageinfo=$(imageInfo)&avinfo=$(avinfo)',
        );
        $token = $auth->uploadToken($bucket, null, 3600, $policy);
